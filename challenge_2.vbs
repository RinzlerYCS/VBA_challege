...
Sub max_vlaue()
    ...
    'MsgBox (greatest_increase_VALUE)
    'MsgBox (greatest_increase_TICKER)
    'MsgBox (greatest_decrease_VALUE)
    'MsgBox (greatest_decrease_TICKER)
    'MsgBox (greatest_total_volume_Value)
    'MsgBox (greatest_total_volume_TICKER)
End Sub
